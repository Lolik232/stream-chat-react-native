...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/MessageInput/components/NativeAttachmentPicker.tsx";
...
var NativeAttachmentPicker = exports.NativeAttachmentPicker = function NativeAttachmentPicker(_ref) {
  ...
  var popupHeight = TOP_PADDING + ATTACH_MARGIN_BOTTOM + attachButtonItemSize;
  ...
  if (hasImagePicker) {
    buttons.push({
      icon: (0, _jsxRuntime.jsx)(ImageSelectorIcon, {}),
      id: 'Image',
  ...
  if (hasFilePicker) {
    buttons.push({
      icon: (0, _jsxRuntime.jsx)(FileSelectorIcon, {}),
      id: 'File',
  ...
  if (hasCameraPicker) {
    buttons.push({
      icon: (0, _jsxRuntime.jsx)(CameraSelectorIcon, {}),
      id: 'Camera',
      onPressHandler: function onPressHandler() {
    ...
    if (_reactNative.Platform.OS === 'android') {
      buttons.push({
        icon: (0, _jsxRuntime.jsx)(VideoRecorderSelectorIcon, {}),
        id: 'Video',
        onPressHandler: function onPressHandler() {
