...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Message/MessageSimple/MessageSimple.tsx";
...
var MessageSimpleWithContext = function MessageSimpleWithContext(props) {
  ...
  var groupStyle = `${alignment}_${groupStyles == null || (_groupStyles$ = groupStyles[0]) == null || _groupStyles$.toLowerCase == null ? void 0 : _groupStyles$.toLowerCase()}`;
...
var areEqual = function areEqual(prevProps, nextProps) {
  var _prevMessage$quoted_m, _nextMessage$quoted_m, _prevOtherAttachments, _nextOtherAttachments;
...
var MessageSimple = exports.MessageSimple = function MessageSimple(props) {
  ...
  var shouldRenderSwipeableWrapper = ((message == null ? void 0 : message.attachments) || []).length > 0 || isAIGenerated;
  return (0, _jsxRuntime.jsx)(MemoizedMessageSimple, Object.assign({
    alignment: alignment,
    channel: channel,
    customMessageSwipeAction: customMessageSwipeAction,
