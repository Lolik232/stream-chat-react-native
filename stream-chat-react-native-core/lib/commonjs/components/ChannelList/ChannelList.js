...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/ChannelList/ChannelList.tsx";
...
var ChannelList = exports.ChannelList = function ChannelList(props) {
  var _props$additionalFlat = props.additionalFlatListProps,
    ...
    queryChannelsOverride = props.queryChannelsOverride;
  ...
  var channelManager = (0, _react.useMemo)(function () {
    return client.createChannelManager({});
  }, [client]);
  (0, _react.useEffect)(function () {
    channelManager.setEventHandlerOverrides({
      ...
      memberUpdatedHandler: onChannelMemberUpdated ? function (setChannels, event) {
        return onChannelMemberUpdated(lockChannelOrder, setChannels, event, {
          filters: filters,
          sort: sort
        });
      } : undefined,
      newMessageHandler: onNewMessage ? function (setChannels, event) {
        return onNewMessage(lockChannelOrder, setChannels, event, {
          filters: filters,
          sort: sort
        });
      } : undefined,
      notificationAddedToChannelHandler: onAddedToChannel ? function (setChannels, event) {
        return onAddedToChannel(setChannels, event, {
          filters: filters,
          sort: sort
        });
      } : undefined,
      notificationNewMessageHandler: onNewMessageNotification ? function (setChannels, event) {
        return onNewMessageNotification(setChannels, event, {
          filters: filters,
          sort: sort
        });
      } : undefined,
  ...
  }, [channelManager, filters, lockChannelOrder, onAddedToChannel, onChannelDeleted, onChannelHidden, onChannelMemberUpdated, onChannelTruncated, onChannelVisible, onNewMessage, onNewMessageNotification, onRemovedFromChannel, sort]);
  (0, _react.useEffect)(function () {
  ...
  var _usePaginatedChannels = (0, _usePaginatedChannels2.usePaginatedChannels)({
    ...
    channelListInitialized = _usePaginatedChannels.channelListInitialized,
