...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Message/MessageSimple/MessageStatus.tsx";
var MessageStatusWithContext = function MessageStatusWithContext(props) {
  ...
  if (threadList || message.status === _utils.MessageStatusTypes.FAILED) {
    return null;
  }
  if (readBy) {
    ...
    var countOfReadBy = typeof readBy === 'number' && hasOtherMembersGreaterThanOne ? readBy - 1 : 0;
    var showDoubleCheck = hasReadByGreaterThanOne || readBy === true;
