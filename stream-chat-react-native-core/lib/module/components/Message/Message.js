...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Message/Message.tsx";
...
var MessageWithContext = function MessageWithContext(props) {
  ...
  var _useTheme = (0, _ThemeContext.useTheme)(),
    ...
    _useTheme$theme$messa2 = _useTheme$theme$messa.unreadUnderlayColor,
    unreadUnderlayColor = _useTheme$theme$messa2 === void 0 ? bg_gradient_start : _useTheme$theme$messa2,
    wrapper = _useTheme$theme$messa.wrapper,
    screenPadding = _useTheme$theme.screenPadding;
  var showMessageOverlay = function () {
    var _ref = (0, _asyncToGenerator2.default)(function* () {
      var showMessageReactions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var selectedReaction = arguments.length > 1 ? arguments[1] : undefined;
      yield dismissKeyboard();
  ...
  var handleAction = function () {
    var _ref2 = (0, _asyncToGenerator2.default)(function* (name, value) {
      if (message.id) {
        var data = yield channel == null ? void 0 : channel.sendAction(message.id, (0, _defineProperty2.default)({}, name, value));
  ...
  return (0, _jsxRuntime.jsx)(_MessageContext.MessageProvider, {
    ...
    children: (0, _jsxRuntime.jsx)(_reactNative.View, {
      ...
      children: (0, _jsxRuntime.jsxs)(_reactNative.View, {
        ...
        }, wrapper, (isTargetedMessage || message.pinned) && !isMessageTypeDeleted ? Object.assign({
...
var areEqual = function areEqual(prevProps, nextProps) {
  var _prevMessage$user, _nextMessage$user, _prevMessage$quoted_m, _nextMessage$quoted_m;
  ...
  var quotedMessageAttachmentsEqual = ((_prevMessage$quoted_m = prevMessage.quoted_message) == null || (_prevMessage$quoted_m = _prevMessage$quoted_m.attachments) == null ? void 0 : _prevMessage$quoted_m.length) === ((_nextMessage$quoted_m = nextMessage.quoted_message) == null || (_nextMessage$quoted_m = _nextMessage$quoted_m.attachments) == null ? void 0 : _nextMessage$quoted_m.length);
...
var Message = exports.Message = function Message(props) {
  ...
  var readBy = (0, _react.useMemo)(function () {
    return (0, _getReadState.getReadState)(message, read);
  }, [message, read]);
