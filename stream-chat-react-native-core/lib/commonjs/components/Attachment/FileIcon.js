...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Attachment/FileIcon.tsx";
...
for (var type of audioFileTypes) {
  mimeTypeToIconMap[type] = _Audio.Audio;
}
for (var _type of docMimeTypes) {
  mimeTypeToIconMap[_type] = _DOC.DOC;
}
for (var _type2 of docXMimeTypes) {
  mimeTypeToIconMap[_type2] = _DOCX.DOCX;
}
for (var _type3 of excelMimeTypes) {
  mimeTypeToIconMap[_type3] = _XLS.XLS;
}
for (var _type4 of excelXMimeTypes) {
  mimeTypeToIconMap[_type4] = _XLSX.XLSX;
}
for (var _type5 of odtMimeTypes) {
  mimeTypeToIconMap[_type5] = _ODT.ODT;
}
for (var _type6 of powerpointMimeTypes) {
  mimeTypeToIconMap[_type6] = _PPT.PPT;
}
for (var _type7 of powerpointXMimeTypes) {
  mimeTypeToIconMap[_type7] = _PPTX.PPTX;
}
for (var _type8 of tarFileTypes) {
  mimeTypeToIconMap[_type8] = _TAR.TAR;
}
for (var _type9 of zipFileTypes) {
  mimeTypeToIconMap[_type9] = _ZIP.ZIP;
}
for (var _type10 of videoFileTypes) {
...
var FileIcon = exports.FileIcon = function FileIcon(_ref) {
