...
var _inAppNotificationsStore = require("../store/in-app-notifications-store");
...
var useInAppNotificationsState = exports.useInAppNotificationsState = function useInAppNotificationsState() {
  ...
  var openInAppNotificationInternal = (0, _useStableCallback.useStableCallback)(function (notificationData) {
    (0, _inAppNotificationsStore.openInAppNotification)(notificationData);
  });
  var closeInAppNotificationInternal = (0, _useStableCallback.useStableCallback)(function (id) {
