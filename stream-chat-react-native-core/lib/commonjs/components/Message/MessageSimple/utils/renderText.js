...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Message/MessageSimple/utils/renderText.tsx";
...
var renderText = exports.renderText = function renderText(params) {
  ...
  }, `${JSON.stringify(mentioned_users)}-${onlyEmojis}-${messageOverlay ? JSON.stringify(markdownStyles) : undefined}-${JSON.stringify(colors)}`);
};
