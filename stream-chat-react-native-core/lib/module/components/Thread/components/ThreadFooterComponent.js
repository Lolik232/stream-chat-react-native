...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Thread/components/ThreadFooterComponent.tsx";
...
var InlineLoadingMoreThreadIndicator = exports.InlineLoadingMoreThreadIndicator = function InlineLoadingMoreThreadIndicator() {
...
var ThreadFooterComponentWithContext = function ThreadFooterComponentWithContext(props) {
  ...
  var _ref = (_useStateStore = (0, _hooks.useStateStore)(threadInstance == null ? void 0 : threadInstance.state, selector)) != null ? _useStateStore : {},
    _ref$replyCount = _ref.replyCount,
    replyCount = _ref$replyCount === void 0 ? thread == null ? void 0 : thread.reply_count : _ref$replyCount;
  if (!thread) {
    return null;
  }
...
var areEqual = function areEqual(prevProps, nextProps) {
  ...
  var latestReactionsEqual = prevThread && nextThread && Array.isArray(prevThread.latest_reactions) && Array.isArray(nextThread.latest_reactions) ? prevThread.latest_reactions.length === nextThread.latest_reactions.length && prevThread.latest_reactions.every(function (_ref2, index) {
...
var ThreadFooterComponent = exports.ThreadFooterComponent = function ThreadFooterComponent(props) {
  ...
  var _useThreadContext2 = (0, _ThreadContext.useThreadContext)(),
    ...
    threadInstance = _useThreadContext2.threadInstance,
