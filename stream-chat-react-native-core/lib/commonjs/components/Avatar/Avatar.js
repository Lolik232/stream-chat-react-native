...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Avatar/Avatar.tsx";
...
var Avatar = exports.Avatar = function Avatar(props) {
  ...
  var uri = (0, _react.useMemo)(function () {
    var imageUrl;
    if (!imageProp || imageProp.includes(randomImageBaseUrl) || imageProp.includes(randomSvgBaseUrl)) {
      if (imageProp != null && imageProp.includes(streamCDN)) {
        imageUrl = imageProp;
      } else {
        imageUrl = `${randomImageBaseUrl}${name ? `?name=${getInitials(name)}&size=${size}` : ''}`;
      }
    } else {
      imageUrl = (0, _getResizedImageUrl.getResizedImageUrl)({
        height: size,
  ...
  return (0, _jsxRuntime.jsxs)(_reactNative.View, {
    children: [(0, _jsxRuntime.jsx)(_reactNative.View, {
      ...
      children: isLoadingImageError ? (0, _jsxRuntime.jsx)(_reactNative.View, {
        ...
        accessibilityLabel: testID != null ? testID : 'Avatar Image',
        onError: onError,
        source: {
          uri: uri
        },
        ...
        testID: testID != null ? testID : 'avatar-image'
      })
