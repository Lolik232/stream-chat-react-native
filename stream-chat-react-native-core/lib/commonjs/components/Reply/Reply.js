...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Reply/Reply.tsx";
...
var getMessageType = function getMessageType(lastAttachment) {
  ...
  if (isLastAttachmentFile) {
    ...
    if (isLastAttachmentImage) {
      messageType = _types.FileTypes.Image;
    } else {
      messageType = undefined;
    }
  } else if (isLastAttachmentGiphy) {
    messageType = _types.FileTypes.Giphy;
  } else {
    messageType = 'other';
  }
  return messageType;
...
var ReplyWithContext = function ReplyWithContext(props) {
  var _quotedMessage$poll_i, _useStateStore, _quotedMessage$attach, _stylesProp$imageAtta, _stylesProp$imageAtta2, _stylesProp$imageAtta3, _stylesProp$imageAtta4, _stylesProp$fileAttac;
  ...
  var poll = client.polls.fromState((_quotedMessage$poll_i = quotedMessage == null ? void 0 : quotedMessage.poll_id) != null ? _quotedMessage$poll_i : '');
  var _ref = (_useStateStore = (0, _hooks.useStateStore)(poll == null ? void 0 : poll.state, selector)) != null ? _useStateStore : {},
    pollName = _ref.name;
  var messageText = quotedMessage ? quotedMessage.text : '';
      ...
      children: [!error && lastAttachment ? messageType === _types.FileTypes.File || messageType === _types.FileTypes.Audio || messageType === _types.FileTypes.VoiceRecording ? (0, _jsxRuntime.jsx)(_reactNative.View, {
        ...
        children: [(0, _jsxRuntime.jsx)(_MessageTextContainer.MessageTextContainer, {
          ...
          message: Object.assign({}, quotedMessage, {
            text: quotedMessage.type === 'deleted' ? `_${t('Message deleted')}_` : quotedMessage.shared_location ? '📍' + t('Location') : pollName ? `📊 ${pollName}` : quotedMessage.text ? quotedMessage.text.length > 170 ? `${quotedMessage.text.slice(0, 170)}...` : quotedMessage.text : messageType === _types.FileTypes.Image ? t('Photo') : messageType === _types.FileTypes.Video ? t('Video') : messageType === _types.FileTypes.File || messageType === _types.FileTypes.Audio || messageType === _types.FileTypes.VoiceRecording ? trimmedLastAttachmentTitle || '' : ''
          }),
...
var areEqual = function areEqual(prevProps, nextProps) {
  var _prevQuotedMessage$at, _nextQuotedMessage$at;
  var prevQuotedMessage = prevProps.quotedMessage;
  var nextQuotedMessage = nextProps.quotedMessage;
  var quotedMessageEqual = !!prevQuotedMessage && !!nextQuotedMessage && (0, _utils.checkQuotedMessageEquality)(prevQuotedMessage, nextQuotedMessage);
  var quotedMessageAttachmentsEqual = (prevQuotedMessage == null || (_prevQuotedMessage$at = prevQuotedMessage.attachments) == null ? void 0 : _prevQuotedMessage$at.length) === (nextQuotedMessage == null || (_nextQuotedMessage$at = nextQuotedMessage.attachments) == null ? void 0 : _nextQuotedMessage$at.length);
...
var Reply = exports.Reply = function Reply(props) {
  ...
  var messageComposer = (0, _contexts.useMessageComposer)();
  var _useStateStore2 = (0, _hooks.useStateStore)(messageComposer.state, messageComposerStateStoreSelector),
  ...
  return (0, _jsxRuntime.jsx)(MemoizedReply, Object.assign({
    ...
    quotedMessage: message ? message.quoted_message : quotedMessage,
    t: t
  }, props));
};
