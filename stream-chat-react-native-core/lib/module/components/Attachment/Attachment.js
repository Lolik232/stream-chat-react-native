...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Attachment/Attachment.tsx";
var AttachmentWithContext = function AttachmentWithContext(props) {
  ...
  if (attachment.type === _types.FileTypes.Image) {
    return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [(0, _jsxRuntime.jsx)(Gallery, {
        images: [attachment]
      }), hasAttachmentActions && (0, _jsxRuntime.jsx)(AttachmentActions, Object.assign({}, attachment), `key-actions-${attachment.image_url}`)]
    });
  }
  if (attachment.type === _types.FileTypes.Video && !attachment.og_scrape_url) {
    return (0, _native.isVideoPlayerAvailable)() ? (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [(0, _jsxRuntime.jsx)(Gallery, {
        videos: [attachment]
      }), hasAttachmentActions && (0, _jsxRuntime.jsx)(AttachmentActions, Object.assign({}, attachment), `key-actions-${attachment.thumb_url}`)]
  ...
  if (hasAttachmentActions) {
    return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [(0, _jsxRuntime.jsx)(Card, Object.assign({}, attachment)), (0, _jsxRuntime.jsx)(AttachmentActions, Object.assign({}, attachment), `key-actions-${attachment.image_url}`)]
    });
  } else {
