...
var useCreateChannelContext = exports.useCreateChannelContext = function useCreateChannelContext(_ref) {
  var channel = _ref.channel,
    channelUnreadState = _ref.channelUnreadState,
    ...
    loadChannelAtFirstUnreadMessage = _ref.loadChannelAtFirstUnreadMessage,
    ...
    setChannelUnreadState = _ref.setChannelUnreadState,
  ...
  var stringifiedChannelUnreadState = JSON.stringify(channelUnreadState);
  ...
  }, [channelId, disabled, error, isChannelActive, highlightedMessageId, lastReadTime, loading, membersLength, readUsersLength, readUsersLastReads, stringifiedChannelUnreadState, targetedMessage, threadList, watcherCount]);
