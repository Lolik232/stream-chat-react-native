...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Attachment/Gallery.tsx";
...
var GalleryWithContext = function GalleryWithContext(props) {
  var additionalPressableProps = props.additionalPressableProps,
    ...
    ImageReloadIndicator = props.ImageReloadIndicator,
    images = props.images,
...
var GalleryThumbnail = function GalleryThumbnail(_ref) {
  ...
  var _useTheme2 = (0, _ThemeContext.useTheme)(),
    ...
    imageContainerStyle = _useTheme2$theme$mess.imageContainerStyle,
  ...
  return (0, _jsxRuntime.jsxs)(_reactNative.Pressable, Object.assign({
  ...
  }), `gallery-item-${message.id}/${colIndex}/${rowIndex}/${imagesAndVideos.length}`);
};
var GalleryImageThumbnail = function GalleryImageThumbnail(_ref3) {
  var borderRadius = _ref3.borderRadius,
    ImageLoadingFailedIndicator = _ref3.ImageLoadingFailedIndicator,
    ImageLoadingIndicator = _ref3.ImageLoadingIndicator,
    ImageReloadIndicator = _ref3.ImageReloadIndicator,
  ...
  return (0, _jsxRuntime.jsx)(_reactNative.View, {
    ...
    children: isLoadingImageError ? (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      ...
      }), (0, _jsxRuntime.jsx)(ImageReloadIndicator, {
      ...
      children: [(0, _jsxRuntime.jsx)(_GalleryImage.GalleryImage, {
        onError: function onError(_ref4) {
          var error = _ref4.nativeEvent.error;
          console.warn(error);
...
var Gallery = exports.Gallery = function Gallery(props) {
  var propAdditionalPressableProps = props.additionalPressableProps,
    ...
    PropImageReloadIndicator = props.ImageReloadIndicator,
  ...
  var _useMessagesContext = (0, _MessagesContext.useMessagesContext)(),
    ...
    ContextImageReloadIndicator = _useMessagesContext.ImageReloadIndicator,
  ...
  var ImageReloadIndicator = PropImageReloadIndicator || ContextImageReloadIndicator;
