...
var _BottomSheetModal = require("../BottomSheetCompatibility/BottomSheetModal");
var _jsxRuntime = require("react/jsx-runtime");
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/ImageGallery/ImageGallery.tsx";
...
var ImageGallery = exports.ImageGallery = function ImageGallery(props) {
  ...
  var _useState = (0, _react.useState)([]),
    ...
    gridPhotos = _useState2[0],
    setGridPhotos = _useState2[1];
  ...
  var _useState3 = (0, _react.useState)(0),
    ...
    currentBottomSheetIndex = _useState4[0],
    setCurrentBottomSheetIndex = _useState4[1];
  ...
  var _useState5 = (0, _react.useState)(fullWindowHeight),
    _useState6 = (0, _slicedToArray2.default)(_useState5, 2),
    currentImageHeight = _useState6[0],
    setCurrentImageHeight = _useState6[1];
  ...
  var photos = (0, _react.useMemo)(function () {
    return messages.reduce(function (acc, cur) {
      ...
      var attachmentImages = ((_cur$attachments = cur.attachments) == null ? void 0 : _cur$attachments.filter(function (attachment) {
        var _attachment$giphy;
        return attachment.type === _types.FileTypes.Giphy && (((_attachment$giphy = attachment.giphy) == null || (_attachment$giphy = _attachment$giphy[giphyVersion]) == null ? void 0 : _attachment$giphy.url) || attachment.thumb_url || attachment.image_url) || attachment.type === _types.FileTypes.Image && !attachment.title_link && !attachment.og_scrape_url && (0, _getUrlOfImageAttachment.getUrlOfImageAttachment)(attachment) || (0, _native.isVideoPlayerAvailable)() && attachment.type === _types.FileTypes.Video;
      }).reverse()) || [];
      var attachmentPhotos = attachmentImages.map(function (a) {
        var _a$giphy;
        var imageUrl = (0, _getUrlOfImageAttachment.getUrlOfImageAttachment)(a);
        var giphyURL = ((_a$giphy = a.giphy) == null || (_a$giphy = _a$giphy[giphyVersion]) == null ? void 0 : _a$giphy.url) || a.thumb_url || a.image_url;
  ...
  var photoSelectedIndex = (0, _react.useMemo)(function () {
    var idx = photos.findIndex(function (photo) {
  ...
  var _useState7 = (0, _react.useState)(photoSelectedIndex),
    _useState8 = (0, _slicedToArray2.default)(_useState7, 2),
    selectedIndex = _useState8[0],
    setSelectedIndex = _useState8[1];
  var index = (0, _reactNativeReanimated.useSharedValue)(photoSelectedIndex);
  var _useState9 = (0, _react.useState)(photos),
    _useState10 = (0, _slicedToArray2.default)(_useState9, 2),
    imageGalleryAttachments = _useState10[0],
    setImageGalleryAttachments = _useState10[1];
  ...
  (0, _react.useEffect)(function () {
    var currentImageHeight = fullWindowHeight;
  ...
  var handlePlayPause = function handlePlayPause(index, pausedStatus) {
    if (pausedStatus === false) {
      ...
      if ((_videoRef$current = videoRef.current) != null && _videoRef$current.play) {
      ...
      if ((_videoRef$current2 = videoRef.current) != null && _videoRef$current2.pause) {
  ...
  var MemoizedImageGridHandle = (0, _react.useCallback)(function () {
  ...
  return (0, _jsxRuntime.jsxs)(_reactNativeReanimated.default.View, {
        ...
        children: (0, _jsxRuntime.jsx)(_reactNativeReanimated.default.View, {
          ...
          children: imageGalleryAttachments.map(function (photo, i) {
            return photo.type === _types.FileTypes.Video ? (0, _jsxRuntime.jsx)(_AnimatedGalleryVideo.AnimatedGalleryVideo, {
              ...
              translateY: translateY,
              videoRef: videoRef
            }, `${photo.uri}-${i}`) : (0, _jsxRuntime.jsx)(_AnimatedGalleryImage.AnimatedGalleryImage, {
    ...
    }), (0, _jsxRuntime.jsx)(_BottomSheetModal.BottomSheetModalProvider, {
      children: (0, _jsxRuntime.jsx)(_BottomSheetModal.BottomSheetModal, {
