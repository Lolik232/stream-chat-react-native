...
var _excluded = ["attachments", "cid", "created_at", "deleted_at", "id", "latest_reactions", "message_text_updated_at", "own_reactions", "poll", "poll_id", "reminder", "reaction_groups", "shared_location", "text", "type", "updated_at", "user"];
var mapMessageToStorable = exports.mapMessageToStorable = function mapMessageToStorable(message) {
