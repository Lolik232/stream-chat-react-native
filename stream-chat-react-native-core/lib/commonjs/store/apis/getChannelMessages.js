...
var getChannelMessages = exports.getChannelMessages = function () {
  var _ref2 = (0, _asyncToGenerator2.default)(function* (_ref) {
    ...
    var messageIdsVsReminders = {};
    var reminders = yield _SqliteClient.SqliteClient.executeSql.apply(null, (0, _createSelectQuery.createSelectQuery)('reminders', ['*'], {
      messageId: messageIds
    }));
    reminders.forEach(function (reminder) {
      messageIdsVsReminders[reminder.messageId] = reminder;
    });
    var messagesWithSharedLocations = messageRows.filter(function (message) {
      return !!message.shared_location;
    });
    var messageIdsVsLocations = {};
    var sharedLocationRows = yield _SqliteClient.SqliteClient.executeSql.apply(null, (0, _createSelectQuery.createSelectQuery)('locations', ['*'], {
      messageId: messagesWithSharedLocations.map(function (message) {
        return message.id;
      })
    }));
    sharedLocationRows.forEach(function (location) {
