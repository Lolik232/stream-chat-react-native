...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Chat/Chat.tsx";
...
var ChatWithContext = function ChatWithContext(props) {
  var _client$user2, _useStateStore, _client$offlineDb;
  var children = props.children,
    ...
    LoadingIndicator = _props$LoadingIndicat === void 0 ? null : _props$LoadingIndicat,
    style = props.style;
  ...
  var translationContextValue = (0, _react.useMemo)(function () {
    var _client$user;
    return Object.assign({}, translators, {
      userLanguage: ((_client$user = client.user) == null ? void 0 : _client$user.language) || _TranslationContext.DEFAULT_USER_LANGUAGE
    });
  }, [(_client$user2 = client.user) == null ? void 0 : _client$user2.language, translators]);
  ...
  var _ref = (_useStateStore = (0, _hooks.useStateStore)((_client$offlineDb = client.offlineDb) == null ? void 0 : _client$offlineDb.state, selector)) != null ? _useStateStore : {},
    offlineDbInitialized = _ref.initialized,
    offlineDbUserId = _ref.userId;
  ...
  (0, _react.useEffect)(function () {
    if (client) {
      var sdkName = _native.NativeHandlers.SDK ? _native.NativeHandlers.SDK.replace('stream-chat-', '') : 'react-native';
  ...
  (0, _react.useEffect)(function () {
    ...
    var initializeDatabase = function () {
      var _ref2 = (0, _asyncToGenerator2.default)(function* () {
        if (!client.offlineDb) {
          client.setOfflineDBApi(new _OfflineDB.OfflineDB({
            client: client
          }));
        }
        if (client.offlineDb) {
          yield client.offlineDb.init(userID);
        }
      });
  ...
  var initialisedDatabase = !!offlineDbInitialized && userID === offlineDbUserId;
  ...
  if (userID && enableOfflineSupport && !initialisedDatabase) {
    return LoadingIndicator ? (0, _jsxRuntime.jsx)(LoadingIndicator, {}) : null;
  }
