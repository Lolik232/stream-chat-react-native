...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/MessageList/MessageList.tsx";
...
var MessageListWithContext = function MessageListWithContext(props) {
  ...
  var minIndexForVisible = Math.min(1, processedMessageList.length);
  var autoscrollToTopThreshold = (0, _react.useMemo)(function () {
    return isLiveStreaming ? 64 : autoscrollToRecent ? 10 : undefined;
  ...
  var maintainVisibleContentPosition = (0, _react.useMemo)(function () {
    return {
      ...
      minIndexForVisible: minIndexForVisible
    };
  ...
  var onScrollEventTimeoutRef = (0, _react.useRef)(undefined);
  var messageIdLastScrolledToRef = (0, _react.useRef)(undefined);
  ...
  var messagesLength = (0, _react.useRef)(processedMessageList.length);
  ...
  }, [threadList, messageListLengthAfterUpdate, topMessageAfterUpdate == null ? void 0 : topMessageAfterUpdate.id]);
  (0, _react.useEffect)(function () {
    if (threadList) {
    ...
    var latestCurrentMessageAfterUpdate = processedMessageList[0];
    ...
    var shouldForceScrollToRecent = !didMergeMessageSetsWithNoUpdates || processedMessageList.length - messageListLengthBeforeUpdate.current > 0;
  ...
  var goToMessage = (0, _hooks.useStableCallback)(function () {
    var _ref4 = (0, _asyncToGenerator2.default)(function* (messageId) {
  ...
  var onScrollToIndexFailedRef = (0, _react.useRef)(function (info) {
    ...
    failScrollTimeoutId.current = setTimeout(function () {
      try {
        ...
        (_flatListRef$current3 = flatListRef.current) == null || _flatListRef$current3.scrollToIndex({
          animated: true,
          index: info.index,
          viewPosition: 0.5
        });
  ...
  var flatListStyle = (0, _react.useMemo)(function () {
    return [styles.listContainer, listContainer, additionalFlatListProps == null ? void 0 : additionalFlatListProps.style];
  }, [additionalFlatListProps == null ? void 0 : additionalFlatListProps.style, listContainer]);
