...
var useCreateMessageContext = exports.useCreateMessageContext = function useCreateMessageContext(_ref) {
  ...
  var reactionsValue = reactions.map(function (_ref2) {
    var count = _ref2.count,
      own = _ref2.own,
      type = _ref2.type;
    return `${own}${type}${count}`;
  }).join();
  var stringifiedMessage = (0, _utils.stringifyMessage)({
    message: message
  });
  ...
  var stringifiedQuotedMessage = message.quoted_message ? (0, _utils.stringifyMessage)({
  ...
  }, [actionsEnabled, alignment, goToMessage, groupStylesLength, hasReactions, isEditedMessageOpen, lastGroupMessage, lastReceivedId, membersValue, myMessageThemeString, reactionsValue, stringifiedMessage, stringifiedQuotedMessage, readBy, showAvatar, showMessageStatus, threadList]);
