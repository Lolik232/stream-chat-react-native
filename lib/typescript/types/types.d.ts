...
export type LocalAudioAttachmentType<CustomLocalMetadata = Record<string, unknown>> = LocalAudioAttachment<CustomLocalMetadata> | LocalVoiceRecordingAttachment<CustomLocalMetadata>;
export type AudioConfig = {
    duration?: number;
    progress?: number;
    paused?: boolean;
};
export type AudioUpload<CustomLocalMetadata = Record<string, unknown>> = LocalAudioAttachmentType<CustomLocalMetadata> & AudioConfig;
