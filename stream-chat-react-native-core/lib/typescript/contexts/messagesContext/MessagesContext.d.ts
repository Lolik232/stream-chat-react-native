...
import type { Attachment, Channel, ChannelState, CommandSuggestion, LocalMessage, MessageResponse } from 'stream-chat';
...
export type MessagesContextValue = Pick<MessageContextValue, 'isMessageAIGenerated'> & {
    ...
    updateMessage: (updatedMessage: MessageResponse | LocalMessage, extraState?: {
        commands?: CommandSuggestion[];
        messageInput?: string;
        threadMessages?: ChannelState['threads'][string];
    }, throttled?: boolean) => void;
    /**
...
export declare const MessagesContext: React.Context<MessagesContextValue>;
export declare const MessagesProvider: ({ children, value, }: PropsWithChildren<{
    value?: MessagesContextValue;
}>) => React.JSX.Element;
export declare const useMessagesContext: () => MessagesContextValue;
