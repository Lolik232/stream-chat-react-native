...
var _excluded = ["user"],
  _excluded2 = ["user"];
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Channel/Channel.tsx";
...
var ChannelWithContext = function ChannelWithContext(props) {
  ...
  var additionalKeyboardAvoidingViewProps = props.additionalKeyboardAvoidingViewProps,
    ...
    messageContentOrder = _props$messageContent === void 0 ? ['quoted_reply', 'gallery', 'files', 'poll', 'ai_text', 'text', 'attachments', 'location'] : _props$messageContent,
