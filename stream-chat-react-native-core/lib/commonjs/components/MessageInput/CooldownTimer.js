...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/MessageInput/CooldownTimer.tsx";
...
var normalizeWidth = function normalizeWidth(seconds) {
  return CONTAINER_SIZE + EXTRA_CHARACTER_PADDING * (`${seconds}`.length - 1);
};
var CooldownTimer = exports.CooldownTimer = function CooldownTimer(props) {
