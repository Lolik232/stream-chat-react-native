...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Poll/components/PollOption.tsx";
...
var VoteButton = exports.VoteButton = function VoteButton(_ref4) {
  ...
  var toggleVote = (0, _react.useCallback)((0, _asyncToGenerator2.default)(function* () {
    if (ownVotesByOptionId[option.id]) {
      var _ownVotesByOptionId$o;
      yield poll.removeVote((_ownVotesByOptionId$o = ownVotesByOptionId[option.id]) == null ? void 0 : _ownVotesByOptionId$o.id, message.id);
    } else {
      yield poll.castVote(option.id, message.id);
    }
