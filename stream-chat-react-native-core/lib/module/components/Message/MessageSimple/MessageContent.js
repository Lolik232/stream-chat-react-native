...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Message/MessageSimple/MessageContent.tsx";
...
var MessageContentWithContext = function MessageContentWithContext(props) {
  var additionalPressableProps = props.additionalPressableProps,
    ...
    MessageLocation = props.MessageLocation,
        ...
        children: messageContentOrder.map(function (messageContentType, messageContentOrderIndex) {
          switch (messageContentType) {
            ...
            case 'files':
              ...
              }, `file_attachment_group_${messageContentOrderIndex}`);
            case 'gallery':
              return (0, _jsxRuntime.jsx)(Gallery, {}, `gallery_${messageContentOrderIndex}`);
            case 'poll':
              {
            ...
            case 'text':
            default:
              return otherAttachments.length && otherAttachments[0].actions || isAIGenerated ? null : (0, _jsxRuntime.jsx)(_MessageTextContainer.MessageTextContainer, {}, `message_text_container_${messageContentOrderIndex}`);
          }
        })
...
var areEqual = function areEqual(prevProps, nextProps) {
  var _prevOtherAttachments, _nextOtherAttachments, _prevMessage$quoted_m, _nextMessage$quoted_m;
...
var MessageContent = exports.MessageContent = function MessageContent(props) {
  ...
  var _useMessagesContext2 = (0, _MessagesContext.useMessagesContext)(),
    ...
    MessageLocation = _useMessagesContext2.MessageLocation,
