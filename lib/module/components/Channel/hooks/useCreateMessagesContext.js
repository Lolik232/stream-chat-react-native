...
var useCreateMessagesContext = exports.useCreateMessagesContext = function useCreateMessagesContext(_ref) {
  var additionalPressableProps = _ref.additionalPressableProps,
    ...
    customMessageSwipeAction = _ref.customMessageSwipeAction,
    ...
    enableSwipeToReply = _ref.enableSwipeToReply,
    ...
    hasCreatePoll = _ref.hasCreatePoll,
    ...
    MessageActionList = _ref.MessageActionList,
    MessageActionListItem = _ref.MessageActionListItem,
    ...
    MessageLocation = _ref.MessageLocation,
    MessageMenu = _ref.MessageMenu,
    MessagePinnedHeader = _ref.MessagePinnedHeader,
    MessageReactionPicker = _ref.MessageReactionPicker,
    ...
    MessageSwipeContent = _ref.MessageSwipeContent,
    messageSwipeToReplyHitSlop = _ref.messageSwipeToReplyHitSlop,
    MessageSystem = _ref.MessageSystem,
    MessageText = _ref.MessageText,
    messageTextNumberOfLines = _ref.messageTextNumberOfLines,
    MessageTimestamp = _ref.MessageTimestamp,
    MessageUserReactions = _ref.MessageUserReactions,
    MessageUserReactionsAvatar = _ref.MessageUserReactionsAvatar,
    MessageUserReactionsItem = _ref.MessageUserReactionsItem,
    ...
    PollContent = _ref.PollContent,
    ReactionListBottom = _ref.ReactionListBottom,
    reactionListPosition = _ref.reactionListPosition,
    ...
    shouldShowUnreadUnderlay = _ref.shouldShowUnreadUnderlay,
    StreamingMessageView = _ref.StreamingMessageView,
    ...
    UnreadMessagesNotification = _ref.UnreadMessagesNotification,
    updateMessage = _ref.updateMessage,
    UrlPreview = _ref.UrlPreview,
    VideoThumbnail = _ref.VideoThumbnail;
  var additionalTouchablePropsLength = Object.keys(additionalPressableProps || {}).length;
  var markdownRulesLength = Object.keys(markdownRules || {}).length;
  var messageContentOrderValue = messageContentOrder.join();
  var supportedReactionsLength = supportedReactions == null ? void 0 : supportedReactions.length;
  ...
  }, [additionalTouchablePropsLength, channelId, disableTypingIndicator, dismissKeyboardOnMessageTouch, initialScrollToFirstUnreadMessage, markdownRulesLength, messageContentOrderValue, supportedReactionsLength, myMessageTheme, targetedMessage, hasCreatePoll]);
