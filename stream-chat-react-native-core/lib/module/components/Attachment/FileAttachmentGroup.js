...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Attachment/FileAttachmentGroup.tsx";
...
var FileAttachmentGroupWithContext = function FileAttachmentGroupWithContext(props) {
  ...
  var onPlayPause = function onPlayPause(index, pausedStatus) {
    if (pausedStatus === false) {
      ...
      setFilesToDisplay(function (prevFilesToDisplay) {
        return prevFilesToDisplay.map(function (fileToDisplay) {
          return Object.assign({}, fileToDisplay, {
            paused: true
          });
        });
  ...
  return (0, _jsxRuntime.jsx)(_reactNative.View, {
    ...
    children: filesToDisplay.map(function (file, index) {
      return (0, _jsxRuntime.jsx)(_reactNative.View, {
        ...
        children: (file.type === _types.FileTypes.Audio || file.type === _types.FileTypes.VoiceRecording) && (0, _native.isSoundPackageAvailable)() ? (0, _jsxRuntime.jsx)(AudioAttachment, {
      ...
      }, `file-by-attachment-group-${messageId}-${index}`);
    })
  });
};
...
var FileAttachmentGroup = exports.FileAttachmentGroup = function FileAttachmentGroup(props) {
