...
export declare const ChannelContext: React.Context<ChannelContextValue>;
export declare const ChannelProvider: ({ children, value, }: PropsWithChildren<{
    value: ChannelContextValue;
}>) => React.JSX.Element;
export declare const useChannelContext: () => ChannelContextValue;
