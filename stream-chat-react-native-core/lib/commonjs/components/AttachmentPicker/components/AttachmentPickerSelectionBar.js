...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/AttachmentPicker/components/AttachmentPickerSelectionBar.tsx";
...
var AttachmentPickerSelectionBar = exports.AttachmentPickerSelectionBar = function AttachmentPickerSelectionBar() {
  ...
  var onCameraPickerPress = function onCameraPickerPress() {
    setSelectedPicker(undefined);
    closePicker();
    takeAndUploadImage(_reactNative.Platform.OS === 'android' ? 'image' : 'mixed');
  };
  var onVideoRecorderPickerPress = function onVideoRecorderPickerPress() {
    setSelectedPicker(undefined);
    closePicker();
