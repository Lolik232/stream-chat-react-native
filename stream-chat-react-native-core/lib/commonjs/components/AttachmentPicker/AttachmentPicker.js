...
var _BottomSheetFlatList = require("../BottomSheetCompatibility/BottomSheetFlatList");
var _jsxRuntime = require("react/jsx-runtime");
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/AttachmentPicker/AttachmentPicker.tsx";
...
var AttachmentPicker = exports.AttachmentPicker = _react.default.forwardRef(function (props, ref) {
  ...
  var endCursorRef = (0, _react.useRef)(undefined);
  ...
  var getMorePhotos = (0, _react.useCallback)((0, _asyncToGenerator2.default)(function* () {
    if (hasNextPageRef.current && !loadingPhotos && currentIndex > -1 && selectedPicker === 'images') {
      setPhotoError(false);
      setLoadingPhotos(true);
      var endCursor = endCursorRef.current;
      try {
        if (!_native.NativeHandlers.getPhotos) {
          setPhotos([]);
          setIosLimited(false);
          return;
        }
        var results = yield _native.NativeHandlers.getPhotos({
          after: endCursor,
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!_native.NativeHandlers.oniOS14GalleryLibrarySelectionChange) {
      return;
    }
    var _NativeHandlers$oniOS = _native.NativeHandlers.oniOS14GalleryLibrarySelectionChange(function () {
        hasNextPageRef.current = true;
        endCursorRef.current = undefined;
        getMorePhotosRef.current();
      }),
      unsubscribe = _NativeHandlers$oniOS.unsubscribe;
    return unsubscribe;
  }, [selectedPicker]);
  (0, _react.useEffect)(function () {
  ...
  var selectedPhotos = (0, _react.useMemo)(function () {
    return photos.map(function (asset) {
      return {
        asset: asset,
  ...
  var MemoizedAttachmentPickerBottomSheetHandle = (0, _react.useCallback)(function (props) {
    return (!photoError && AttachmentPickerBottomSheetHandle ? (0, _jsxRuntime.jsx)(AttachmentPickerBottomSheetHandle, Object.assign({}, props)) : null
    );
  }, [AttachmentPickerBottomSheetHandle, photoError]);
  return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [(0, _jsxRuntime.jsxs)(_BottomSheet.BottomSheet, {
      ...
      children: [iOSLimited && (0, _jsxRuntime.jsx)(AttachmentPickerIOSSelectMorePhotos, {}), (0, _jsxRuntime.jsx)(_BottomSheetFlatList.BottomSheetFlatList, {
