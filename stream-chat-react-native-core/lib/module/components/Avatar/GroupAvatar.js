...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/Avatar/GroupAvatar.tsx";
...
var GroupAvatar = exports.GroupAvatar = function GroupAvatar(props) {
      ...
      return (0, _jsxRuntime.jsx)(_reactNative.View, {
        ...
        children: column.map(function (_ref, rowIndex) {
          ...
          return (0, _jsxRuntime.jsx)(ImageComponent, {
            ...
            source: {
              uri: url.includes(randomSvgBaseUrl) ? url.includes(streamCDN) ? url : `${randomImageBaseUrl}${name ? `?name=${getInitials(name)}&size=${height}` : ''}` : (0, _getResizedImageUrl.getResizedImageUrl)({
                height: height,
