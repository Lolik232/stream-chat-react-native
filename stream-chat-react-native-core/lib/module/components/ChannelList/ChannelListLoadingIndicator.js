...
var _this = this,
  _jsxFileName = "/Users/what1slove/Dev/ownit/stream-chat-react-native/stream-chat-react-native-core/src/components/ChannelList/ChannelListLoadingIndicator.tsx";
var styles = _reactNative.StyleSheet.create({
  container: {
    flex: 1
  }
});
var ChannelListLoadingIndicator = exports.ChannelListLoadingIndicator = function ChannelListLoadingIndicator() {
  ...
  return (0, _jsxRuntime.jsx)(_reactNative.View, {
    ...
    children: Array.from(Array(numberOfSkeletons)).map(function (_, index) {
      return (0, _jsxRuntime.jsx)(Skeleton, {}, `skeleton_${index}`);
    })
  });
};
